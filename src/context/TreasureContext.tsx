...
const initialTreasuresData: Treasure[] = [
  {
    ...
    quiz: {
      ...
      question: '풍선초의 꽃말은 무엇일까요? (힌트: 어린시절의 재미, 영원한 사랑과 추억)',
      answer: '잊지 않겠다는 약속'
    }
  },
  {
    ...
    quiz: {
      image: '/miyastore.png',
      question: '아버지가 매주 일요일마다 목욕탕 다녀온 후 사오던 음식은? (힌트: 바나나우유 CM송)',
      answer: '바나나우유'
    }
  },
  {
    ...
    name: '능소화 고택',
    subtitle: '미션 3',
    description: '능소화 사진 - 아버지가 좋아하던 꽃 앞에서 예쁜 사진 찍기',
    icon: '📸',
    found: false,
    lat: 35.229500, lng: 128.879000, // 능소화 고택 추정 좌표
    quiz: {
      image: '/taengja.png',
      question: '능소화는 언제 피는 꽃일까요? (힌트: 여름에 피었다 지는 꽃)',
      answer: '여름'
    }
  },
  {
    ...
    quiz: {
      image: '/taengja.png',
      question: '아버지가 소영을 생각하며 신청한 노래는? (힌트: 이문세의 노래, 소녀로 남아주길 바랐던 아버지의 마음)',
      answer: '소녀'
    }
  },
  {
    ...
    name: '방하림',
    subtitle: '미션 5',
    description: '가족오락관 - 아버지가 준비한 마지막 소원, 가족과 함께 게임하기',
    icon: '🎮',
    found: false,
    lat: 35.230000, lng: 128.880000, // 방하림 추정 좌표
    quiz: {
      image: '',
      question: '봉황메모리즈의 자음만 따면? (힌트: ㅂㅎㅁㅁㄹㅈ)',
      answer: '봉황메모리즈'
    }
  },
];
